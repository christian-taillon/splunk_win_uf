...
wget -O splunkforwarder-9.1.1-64e843ea36b1-x64-release.msi "https://download.splunk.com/products/universalforwarder/releases/9.1.1/windows/splunkforwarder-9.1.1-64e843ea36b1-x64-release.msi"
...
msiexec /i splunkforwarder-9.1.1-64e843ea36b1-x64-release.msi AGREETOLICENSE=Yes GENRANDOMPASSWORD=1 /quiet
